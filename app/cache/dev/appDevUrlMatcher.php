    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/css/style')) {
            ...
            if ($pathinfo === '/css/style.css') {
                return array (  '_controller' => 'assetic.controller:render',  'name' => 'e3a8a9d',  'pos' => NULL,  '_format' => 'css',  '_route' => '_assetic_e3a8a9d',);
            }
            ...
            if (0 === strpos($pathinfo, '/css/style_')) {
                if (0 === strpos($pathinfo, '/css/style_bootstrap')) {
                    ...
                    if ($pathinfo === '/css/style_bootstrap_1.css') {
                        return array (  '_controller' => 'assetic.controller:render',  'name' => 'e3a8a9d',  'pos' => 0,  '_format' => 'css',  '_route' => '_assetic_e3a8a9d_0',);
                    }

                    // _assetic_e3a8a9d_1
                    if ($pathinfo === '/css/style_bootstrap-responsive_2.css') {
                        return array (  '_controller' => 'assetic.controller:render',  'name' => 'e3a8a9d',  'pos' => 1,  '_format' => 'css',  '_route' => '_assetic_e3a8a9d_1',);
                    }
                ...
                if ($pathinfo === '/css/style_style_3.css') {
                    return array (  '_controller' => 'assetic.controller:render',  'name' => 'e3a8a9d',  'pos' => 2,  '_format' => 'css',  '_route' => '_assetic_e3a8a9d_2',);
                }
        ...
        if (0 === strpos($pathinfo, '/js/scripts')) {
            ...
            if ($pathinfo === '/js/scripts.js') {
                return array (  '_controller' => 'assetic.controller:render',  'name' => '6f246d9',  'pos' => NULL,  '_format' => 'js',  '_route' => '_assetic_6f246d9',);
            }

            if (0 === strpos($pathinfo, '/js/scripts_')) {
                // _assetic_6f246d9_0
                if ($pathinfo === '/js/scripts_jquery-1.9.1_1.js') {
                    return array (  '_controller' => 'assetic.controller:render',  'name' => '6f246d9',  'pos' => 0,  '_format' => 'js',  '_route' => '_assetic_6f246d9_0',);
                }

                // _assetic_6f246d9_1
                if ($pathinfo === '/js/scripts_bootstrap_2.js') {
                    return array (  '_controller' => 'assetic.controller:render',  'name' => '6f246d9',  'pos' => 1,  '_format' => 'js',  '_route' => '_assetic_6f246d9_1',);
                }

                // _assetic_6f246d9_2
                if ($pathinfo === '/js/scripts_highcharts_3.js') {
                    return array (  '_controller' => 'assetic.controller:render',  'name' => '6f246d9',  'pos' => 2,  '_format' => 'js',  '_route' => '_assetic_6f246d9_2',);
                }

                // _assetic_6f246d9_3
                if ($pathinfo === '/js/scripts_part_4_script_1.js') {
                    return array (  '_controller' => 'assetic.controller:render',  'name' => '6f246d9',  'pos' => 3,  '_format' => 'js',  '_route' => '_assetic_6f246d9_3',);
                }
